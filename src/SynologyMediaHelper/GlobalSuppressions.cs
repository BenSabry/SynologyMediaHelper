...
[assembly: SuppressMessage("Globalization", "CA1305:Specify IFormatProvider", Justification = "<Pending>", Scope = "member", Target = "~M:SynologyMediaHelper.Core.Engine.FilePathIsAlignedWithDate(System.IO.FileInfo,System.DateTime)~System.Boolean")]
[assembly: SuppressMessage("Major Code Smell", "S6561:Avoid using \"DateTime.Now\" for benchmarking or timing operations", Justification = "<Pending>", Scope = "member", Target = "~M:SynologyMediaHelper.Core.Engine.LogProgress(System.String)")]
